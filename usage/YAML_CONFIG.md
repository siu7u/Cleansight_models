...
| [`framework/experiments/gru-actionmixed-auto-hand.yaml`](../framework/experiments/gru-actionmixed-auto-hand.yaml) | GRU、40 维手部相对坐标（8 类 × [presence, cx/cy/w/h_rel]）、6 类、16 帧窗口、`dataset_ref: temporal.actionmixed-auto-hand-v1` | feature-lab 手部基准特征（hand-40）对照实验。 |
| [`framework/experiments/gru-actionmixed-auto-global-hand.yaml`](../framework/experiments/gru-actionmixed-auto-global-hand.yaml) | GRU、80 维（全局 40 + 手部 40 拼接）、16 帧窗口、`dataset_ref: temporal.actionmixed-auto-global-hand-v1` | global-hand-80 基线对照实验。 |
| [`framework/experiments/gru-actionmixed-auto-cnn.yaml`](../framework/experiments/gru-actionmixed-auto-cnn.yaml) | GRU、120 维区域统计（8 类 × 6 区域 × [presence, count, max_area]）、16 帧窗口、`dataset_ref: temporal.actionmixed-auto-cnn-v1` | 区域统计特征（cnn-120）基线对照实验。 |
| [`framework/experiments/gru-actionmixed-auto-hand-cnn.yaml`](../framework/experiments/gru-actionmixed-auto-hand-cnn.yaml) | GRU、160 维手部区域统计（8 类 × 6 区域 × 3 通道）、16 帧窗口、`dataset_ref: temporal.actionmixed-auto-hand-cnn-v1` | 手部区域统计（hand-cnn-160）基线对照实验。 |
| [`framework/experiments/gru-actionmixed-auto-roi.yaml`](../framework/experiments/gru-actionmixed-auto-roi.yaml) | GRU、144 维 ROI 区域统计（8 类 × 6 区域 × 3 通道）、16 帧窗口、`dataset_ref: temporal.actionmixed-auto-roi-v1` | roi-144 参照特征，feature-lab 矩阵的对照基线之一。 |
| [`framework/experiments/gru-actionmixed-auto-clean-v2.yaml`](../framework/experiments/gru-actionmixed-auto-clean-v2.yaml) | GRU、113 维 clean_bbox_v2、16 帧窗口、split_eval=val；无 dataset_ref（显式绝对 root，exploratory 探针口径） | v2 特征 GRU 对照探针（NEXT_STEPS §1.1-#1）；正式采用需转 catalog 契约。 |
| [`framework/experiments/gru-actionmixed-auto-clean-v3.yaml`](../framework/experiments/gru-actionmixed-auto-clean-v3.yaml) | GRU、113 维 clean_bbox_v3、16 帧窗口、`dataset_ref: temporal.actionmixed-auto-clean-v3`、split_eval=val | v3 特征正面对比实验（FEATURE_LAB §7.1）。 |
| [`framework/experiments/mstcn-clean-v3.yaml`](../framework/experiments/mstcn-clean-v3.yaml) | MS-TCN 全序列、113 维 clean_bbox_v3、`dataset_ref: temporal.actionmixed-auto-clean-v3`、split_eval=val | MS-TCN 特征质量探针（v3 vs v2，FEATURE_LAB §7）。 |
| [`framework/experiments/mstcn-clean-v2-baseline.yaml`](../framework/experiments/mstcn-clean-v2-baseline.yaml) | MS-TCN 全序列、113 维 clean_bbox_v2、split_eval=val；无 dataset_ref（Windows 绝对路径，工程债见 NEXT_STEPS §1.2） | v2 的 MS-TCN 基线探针；待登记 catalog 契约。 |
| [`framework/experiments/gru-actionmixed-auto-v2v3.yaml`](../framework/experiments/gru-actionmixed-auto-v2v3.yaml) | GRU、226 维 v2⊕v3 拼接、16 帧窗口、split_eval=val；无 dataset_ref（显式绝对 root，exploratory 探针口径） | v2⊕v3 拼接双赢探针（FEATURE_LAB §7.3，曾创全项目纪录）。 |
| [`framework/experiments/gru-actionmixed-auto-v3roi.yaml`](../framework/experiments/gru-actionmixed-auto-v3roi.yaml) | GRU、257 维 v3⊕roi 拼接、16 帧窗口、split_eval=val；无 dataset_ref（显式绝对 root，exploratory 探针口径） | v3⊕roi 拼接探针（判据未通过，FEATURE_LAB §7.2）。 |
| [`framework/experiments/gru-actionmixed-auto-v4.yaml`](../framework/experiments/gru-actionmixed-auto-v4.yaml) | GRU、60 维 clean_bbox_v4（废弃目标剔除）、16 帧窗口、`dataset_ref: temporal.actionmixed-auto-v4`、split_eval=test（project-18 跨批次专项） | v4 矩阵实验（FEATURE_LAB §8）。 |
| [`framework/experiments/gru-actionmixed-auto-roi-v4.yaml`](../framework/experiments/gru-actionmixed-auto-roi-v4.yaml) | GRU、108 维 roi-v4（8→6 类重映射）、16 帧窗口、`dataset_ref: temporal.actionmixed-auto-roi-v4`、split_eval=test | v4 对照矩阵的 roi 侧实验（FEATURE_LAB §8）。 |
| [`framework/experiments/gru-actionmixed-auto-nodep.yaml`](../framework/experiments/gru-actionmixed-auto-nodep.yaml) | GRU、226 维 nodep（v2⊕v3 同编码 + 废弃类检测行剔除）、16 帧窗口、split_eval=test；无 dataset_ref（显式绝对 root，探针口径） | 当前特征定版候选 `ama-v3-concat23-nodep-226d` 的消融实验（FEATURE_LAB §8.4/§9）；正式登记 catalog 待办。 |
| [`framework/experiments/mstcn-actionmixed-auto-roi.yaml`](../framework/experiments/mstcn-actionmixed-auto-roi.yaml) | MS-TCN 全序列、144 维 ROI 区域统计、`dataset_ref: temporal.actionmixed-auto-roi-v1`、split_eval=val | roi 特征的 MS-TCN 模型族对照。 |
| [`framework/experiments/transformer-actionmixed-auto-roi.yaml`](../framework/experiments/transformer-actionmixed-auto-roi.yaml) | Transformer、144 维 ROI 区域统计、`max_len: 2560`、`dataset_ref: temporal.actionmixed-auto-roi-v1`、split_eval=val | roi 特征的 Transformer 模型族对照。 |
